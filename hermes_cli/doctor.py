...
def run_doctor(args):
    ...
    _apikey_providers = [
        ...
        ("Moonshot (global)",    ("MOONSHOT_API_KEY",),                          "https://api.moonshot.ai/v1/models",   "MOONSHOT_BASE_URL", True),
        ...
        ("Moonshot (domestic)",  ("MOONSHOT_CN_API_KEY",),                        "https://api.moonshot.cn/v1/models",  "MOONSHOT_CN_BASE_URL", True),
